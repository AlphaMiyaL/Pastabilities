...
public class ConsumeItem : MonoBehaviour
{
    ...
    public AudioClip speedSFX, bulletSpeedSFX, bulletDamageSFX, fullShieldSFX, semiShieldSFX; 
    ...
    public void Use()
    {
        ...
        {
            AudioManager.instance.PlaySound(bulletDamageSFX);
        ...
        {
            AudioManager.instance.PlaySound(fullShieldSFX);
            PlayerStats stats = player.GetComponent<PlayerStats>();
            stats.activateFullShield();
        }
        else // tag == "FrontShield" // green potion
        {
            AudioManager.instance.PlaySound(semiShieldSFX);
            PlayerStats stats = player.GetComponent<PlayerStats>();
